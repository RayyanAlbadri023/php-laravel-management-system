<?php $__env->startSection('title', 'Employee System — Register'); ?>
...
<div class="card">
    ...
    <div class="tabs">
        ...
        <a href="<?php echo e(route('register')); ?>" class="tab active">Register</a>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('register.post')); ?>" novalidate>
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" placeholder="you@example.com"
                   ...
                   class="<?php echo e($errors->has('email') ? 'err' : ''); ?>" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select name="department">
                ...
                <option value="HR"          <?php echo e(old('department')=='HR'          ? 'selected':''); ?>>HR</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\wamp64last\www\PHP_LARAVEL\resources\views/auth/register.blade.php ENDPATH**/ ?>